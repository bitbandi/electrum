...
from electrum_dmd.util import format_satoshis, set_verbosity
from electrum_dmd.bitcoin import is_valid, COIN, TYPE_ADDRESS
from electrum_dmd.network import filter_protocol
...
class ElectrumGui:
    ...
    def __init__(self, config, daemon, plugins):
        ...
        if not storage.file_exists:
            print "Wallet not found. try 'electrum-dmd create'"
            exit()
    ...
    def do_send(self):
        if not is_valid(self.str_recipient):
            print(_('Invalid Diamond address'))
            return
        try:
    ...
    def network_dialog(self):
        print("use 'electrum-dmd setconfig server/proxy' to change your network settings")
        return True


    def settings_dialog(self):
        print("use 'electrum-dmd setconfig' to change your settings")
        return True
