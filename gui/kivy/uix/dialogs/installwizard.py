...
from electrum_dmd_gui.kivy.uix.dialogs import EventsDialog
from electrum_dmd_gui.kivy.i18n import _
from electrum_dmd.base_wizard import BaseWizard
...
#:import _ electrum_dmd_gui.kivy.i18n._
...
class RestoreSeedDialog(WizardDialog):
    ...
    def __init__(self, wizard, **kwargs):
        ...
        from electrum_dmd.old_mnemonic import words as old_wordlist
