...
import electrum_dmd
from electrum_dmd.bitcoin import TYPE_ADDRESS
from electrum_dmd import WalletStorage, Wallet
from electrum_dmd_gui.kivy.i18n import _
from electrum_dmd.paymentrequest import InvoiceStore
from electrum_dmd.util import profiler, InvalidPassword
from electrum_dmd.plugins import run_hook
from electrum_dmd.util import format_satoshis, format_satoshis_plain
...
Factory.register('InstallWizard',
                 module='electrum_dmd_gui.kivy.uix.dialogs.installwizard')
Factory.register('InfoBubble', module='electrum_dmd_gui.kivy.uix.dialogs')
Factory.register('OutputList', module='electrum_dmd_gui.kivy.uix.dialogs')
Factory.register('OutputItem', module='electrum_dmd_gui.kivy.uix.dialogs')
...
# the data
Cache.register('electrum_dmd_widgets', timeout=0)
...
Factory.register('TabbedCarousel', module='electrum_dmd_gui.kivy.uix.screens')
...
from electrum_dmd.util import base_units
...
class ElectrumWindow(App):
    ...
    def choose_server_dialog(self, popup):
        ...
        protocol = 's'
        def cb2(host):
            from electrum_dmd.network import DEFAULT_PORTS
    ...
    def _get_bu(self):
        return self.electrum_config.get('base_unit', 'DMD')
    ...
    def on_qr(self, data):
        from electrum_dmd.bitcoin import base_decode, is_address
        data = data.strip()
        if is_address(data):
            self.set_URI(data)
            return
        ...
        from electrum_dmd.transaction import Transaction
        try:
    ...
    def show_pr_details(self, req, status, is_invoice):
        from electrum_dmd.util import format_time
    ...
    def init_ui(self):
        ...
        Factory.register('AnimatedPopup',
                         module='electrum_dmd_gui.kivy.uix.dialogs')
        Factory.register('QRCodeWidget',
                         module='electrum_dmd_gui.kivy.uix.qrcodewidget')

        # preload widgets. Remove this if you want to load the widgets on demand
        #Cache.append('electrum_dmd_widgets', 'AnimatedPopup', Factory.AnimatedPopup())
        #Cache.append('electrum_dmd_widgets', 'QRCodeWidget', Factory.QRCodeWidget())
        ...
        self.icon = "icons/electrum-dmd.png"
    ...
    def notify(self, message):
        try:
            ...
            icon = (os.path.dirname(os.path.realpath(__file__))
                    + '/../../' + self.icon)
            notification.notify('Electrum-DMD', message,
                            app_icon=icon, app_name='Electrum-DMD')
        except ImportError:
