...
SYSTEM_CONFIG_PATH = "/etc/electrum-dmd.conf"
...
class SimpleConfig(PrintError):
    ...
    def get_wallet_path(self):
        ...
        old_path = os.path.join(self.path, "electrum-dmd.dat")
...
def read_system_config(path=SYSTEM_CONFIG_PATH):
    """Parse and return the system config settings in /etc/electrum-dmd.conf."""
    result = {}
...
def read_user_config(path):
    """Parse and store the user config settings in electrum-dmd.conf into user_config[]."""
    if not path:
        return {}
