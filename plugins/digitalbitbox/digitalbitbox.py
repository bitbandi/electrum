...
try:
    import electrum_dmd
    from electrum_dmd.bitcoin import TYPE_ADDRESS, var_int, msg_magic, Hash, verify_message, pubkey_from_signature, point_to_ser, public_key_to_p2pkh, EncodeAES, DecodeAES, MyVerifyingKey
    from electrum_dmd.i18n import _
    from electrum_dmd.keystore import Hardware_KeyStore
    from ..hw_wallet import HW_PluginBase
    from electrum_dmd.util import print_error
